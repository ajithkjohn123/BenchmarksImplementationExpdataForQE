...
// Function which computes \exists X. \pi using Layer1 and Layer2, 
// where X is a set of variables in \pi
// and \pi is a conjunction of LMEs, LMDs, and LMIs
// Helps in solving
DAGNode* Layer1AndLayer2(vector<DAGNode*> &Constraints, set<string> &VarsToElim, map<string, int> &WidthTable, int project_depth)
{
// Local versions of the conjunction-level data start here
int PresentConjunctionNumberLocal=0;
int LMINoVarsToElimLocal=0;
 ...
 // Local versions of the conjunction-level data end here  
  ...
  if(output_conjunctions && project_depth == 0)
	...
	createConjunctionAndPrintInSMTLibFormat(Bound_Constraints_Vector, VarsToElim, WidthTable);
      ...
      total_number_of_constraints_to_preprocess = Bound_Constraints.size();
      total_number_of_variables_to_preprocess = LMINoVarsLocal;
      total_number_of_lmes_to_preprocess = LMINoLMEsLocal;
      total_number_of_lmds_to_preprocess = LMINoLMDsLocal;
      total_number_of_lmis_to_preprocess = LMINoLMIsLocal;
      //Apply Layer1      
	  ...
	  //cout << "\nLayer1 is successful in eliminating all the quantifiers\n";
	  ...
	  total_number_of_constraints_to_preprocess_input_to_layer2 = 0;
	  total_number_of_constraints_to_preprocess_input_to_layer3 = 0;
	  total_number_of_variables_to_preprocess_input_to_layer2 = 0;
	  total_number_of_variables_to_preprocess_input_to_layer3 = 0;
	  layer1_time_to_preprocess = LMILayer1TimeLocal;
	  layer2_time_to_preprocess = 0;
      ...
      //cout << "\nLayer1 is NOT successful in eliminating all the quantifiers\n";
      ...
      total_number_of_constraints_to_preprocess_input_to_layer2 = Quantified_Bound_Part_Constraint_Set.size();
      total_number_of_variables_to_preprocess_input_to_layer2 = LMIVarsInputToLayer2Local;
	  ...
	  //cout << "\nLayer2 is successful in eliminating all the quantifiers\n";
	  ...
	  total_number_of_variables_to_preprocess_input_to_layer3 = 0;
	  layer1_time_to_preprocess = LMILayer1TimeLocal;
	  layer2_time_to_preprocess = LMILayer2TimeLocal;
      ...
      {
	//cout << "\nLayer2 is NOT successful in eliminating all the quantifiers\n";
	...
	set<DAGNode*> InputToLayer3_Constraints;
        ...
        total_number_of_constraints_to_preprocess_input_to_layer3 = InputToLayer3_Constraints.size();
	total_number_of_variables_to_preprocess_input_to_layer3 = LMIVarsInputToLayer3Local;
	layer1_time_to_preprocess = LMILayer1TimeLocal;
	layer2_time_to_preprocess = LMILayer2TimeLocal;


	DAGNode* resultDAG; //Result of QE 
        resultDAG = quickSimplify_WithLMISupport(createDAG("and", PartialResultDAG, InputToLayer3, LOGICAL_SYMBOL, 1));
	return resultDAG;
      }
